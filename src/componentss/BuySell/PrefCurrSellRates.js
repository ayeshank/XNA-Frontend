  ...
  return (
    <div>
      ...
      <p className="xnaratep">
        {t("Equivalent Sell Amount In Your Selected Preffered Currencies")}
      </p>
          ...
          {arr.map((item) =>
            item === "CAD" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.CAD).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "CHF" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.CHF).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "CNY" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.CNY).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "DKK" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.DKK).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "EUR" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.EUR).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "GBP" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.GBP).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "INR" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.INR).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "JPY" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.JPY).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "KWD" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.KWD).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "MYR" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.MYR).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "NOK" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.NOK).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "PKR" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.PKR).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "QAR" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.QAR).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "RUB" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.RUB).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "SEK" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.SEK).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "SGD" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.SGD).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "TRY" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.TRY).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
          ...
          {arr.map((item) =>
            item === "USD" ? (
              <tr>
                ...
                <td>
                  {(parseFloat(props.sellamt) * cRates[0].data.USD).toFixed(9)}
                </td>
              </tr>
            ) : (
              ""
